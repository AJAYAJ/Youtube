package com.myworks.youtubeapp.views
...
import com.myworks.youtubeapp.R
import com.pierfrancescosoffritti.androidyoutubeplayer.core.player.PlayerConstants
import com.pierfrancescosoffritti.androidyoutubeplayer.core.player.YouTubePlayer
import com.pierfrancescosoffritti.androidyoutubeplayer.core.player.listeners.YouTubePlayerListener
import com.myworks.youtubeapp.utils.TimeUtilities
...
class YouTubePlayerSeekBar(context: Context, attrs: AttributeSet? = null) :
  ...
  init {
    ...
    videoCurrentTimeTextView.setTextColor(ContextCompat.getColor(context, R.color.white))
    ...
    videoDurationTextView.setTextColor(ContextCompat.getColor(context, R.color.white))
